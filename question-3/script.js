...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Occupations Decades creating chart
    await initDecadesOccupations(occupationsGroups.architectureSculpture);
    await createOccupationsDecadesChart(occupationsGroups.architectureSculpture)
